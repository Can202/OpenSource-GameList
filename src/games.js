...
if (tag == "strategy" || tag == "online_multiplayer" || tag == "rpg" || tag == "sandbox" || tag == "home"){
    ...
    document.write('<img src="/OpenSource-GameList/src/images/mac.png" width="15px" />'); //mac
    //document.write('<img src="/OpenSource-GameList/src/images/android.png" width="15px" />'); //android
    document.write('<font style="font-size:10px;"> - strategy, online_multiplayer, rpg, sandbox</font>');
    document.write('</li>');
}
...
if (tag == "action" || tag == "shooter" || tag == "online_multiplayer" || tag == "home"){
    total = total + 1;
    document.write('<li><a href="https://store.steampowered.com/app/671610/Warfork/" target="_blank">Warfork</a> - (fork of Warsow)futuristic cartoonish world fast-paced first-person shooter');
    document.write('<img src="/OpenSource-GameList/src/images/windows.png" width="15px" />'); //windows
    document.write('<img src="/OpenSource-GameList/src/images/linux.png" width="15px" />'); //linux
    document.write('<img src="/OpenSource-GameList/src/images/mac.png" width="15px" />'); //mac
    //document.write('<img src="/OpenSource-GameList/src/images/android.png" width="15px" />'); //android
...
if (tag == "strategy" || tag == "online_multiplayer" || tag == "action" || tag == "simulation" || tag == "home"){
    ...
    document.write('<img src="/OpenSource-GameList/src/images/mac.png" width="15px" />'); //mac
    //document.write('<img src="/OpenSource-GameList/src/images/android.png" width="15px" />'); //android
    document.write('<font style="font-size:10px;"> - strategy, online_multiplayer, action, simulation</font>');
    document.write('</li>');
}
...
if (tag == "action" || tag == "shooter" || tag == "local_multiplayer" || tag == "online_multiplayer" || tag == "android" || tag == "home"){
    ...
    document.write('<img src="/OpenSource-GameList/src/images/mac.png" width="15px" />'); //mac
    document.write('<img src="/OpenSource-GameList/src/images/android.png" width="15px" />'); //android
    document.write('<font style="font-size:10px;"> - action, shooter, local_multiplayer, online_multiplayer, android</font>');
    document.write('</li>');
}
...
if (tag == "action" || tag == "racing" || tag == "online_multiplayer" || tag == "home"){
    ...
    document.write('<img src="/OpenSource-GameList/src/images/mac.png" width="15px" />'); //mac
    //document.write('<img src="/OpenSource-GameList/src/images/android.png" width="15px" />'); //android
    document.write('<font style="font-size:10px;"> - action, racing, online_multiplayer</font>');
    document.write('</li>');
}
...
if (tag == "action" || tag == "metroidvania" || tag == "plataformer" || tag == "shooter" || tag == "home"){
    ...
    document.write('<img src="/OpenSource-GameList/src/images/mac.png" width="15px" />'); //mac
    //document.write('<img src="/OpenSource-GameList/src/images/android.png" width="15px" />'); //android
    document.write('<font style="font-size:10px;"> - metroidvania, shooter, plataformer, action</font>');
    document.write('</li>');
}
...
if (tag == "casual" || tag == "android" || tag == "home"){
    ...
    //document.write('<img src="/OpenSource-GameList/src/images/mac.png" width="15px" />'); //mac
    document.write('<img src="/OpenSource-GameList/src/images/android.png" width="15px" />'); //android
    document.write('<font style="font-size:10px;"> - casual, android</font>');
    document.write('</li>');
}
